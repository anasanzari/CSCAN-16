    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 col-xs-12">
          <h1>Committee</h1>
          <h2>Convenor<h2>
            <p class="convenor">Dr S. D Madhukumar<br>Associate Professor and Former Head of the CSE Department, NIT Calicut.</p>
          <h2>Members</h3>
            <ul>
              <li>Dr K. A Abdul Naseer, Head of the CSE Department, NIT Calicut</li>
              <li>Ms Lijiya A</li>
              ...
              <li>Vishu Priya Matha</li>
              <li>Vivek Kumar</li>
              <li>Ojus Thomas Lee</li>
              <li>Denny Thomas</li>
              <li>Shishir Kumar</li>
              <li>Supriya Soni</li>
              <li>K Sathya Kumar</li>
              <li>Anas M</li>
            </ul>
        </div>
      </div>
